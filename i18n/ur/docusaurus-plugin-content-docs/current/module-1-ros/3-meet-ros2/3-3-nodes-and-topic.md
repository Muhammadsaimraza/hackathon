...
پچھلے سبق میں، آپ نے Turtlesim چلایا۔ آپ کے پاس ایک turtlesim_node پروسیس اور ایک turtle_teleop_key پروسیس ہے۔ لیکن ROS کے نقطہ نظر سے، یہ صرف عام پروسیسز ہیں۔ آئیے os2 CLI کا استعمال کرکے دیکھیں کہ اصل میں کیا ہو رہا ہے۔
...
/teleop_turtle
`
یہ ان دو نوڈس کے نام ہیں جو فی الحال چل رہے ہیں۔ نوٹ کریں کہ /teleop_turtle turtle_teleop_key ایگزیکیوٹیبل کا ڈیفالٹ نام ہے۔
...
*   /turtle1/pose: turtlesim_node کچھوے کی موجودہ پوزیشن اور اوریئنٹیشن (اس کا "پوز") اس ٹاپک پر پبلش کرتا ہے۔ اس طرح دوسرے نوڈس جان سکتے ہیں کہ کچھوا کہاں ہے۔
*   باقی دو ٹاپکس سسٹم وائڈ ایونٹس اور لاگنگ کے لیے استعمال ہوتے ہیں۔

## ایک ٹاپک پر جاسوسی کرنا

ہم os2 topic echo کا استعمال کرکے ان پیغامات کو حقیقی وقت میں پرنٹ کر سکتے ہیں جو ایک ٹاپک پر پبلش ہو رہے ہیں۔ آئیے کمانڈ ویلوسٹی ٹاپک کو سنتے ہیں۔

اپنے تیسرے ٹرمینل میں، چلائیں:
`bash
ros2 topic echo /turtle1/cmd_vel
`
پہلے تو آپ کو کچھ نظر نہیں آئے گا۔ لیکن اب، turtle_teleop_key چلانے والے ٹرمینل پر جائیں اور تیر والے بٹن دبائیں۔ آپ کو اپنے تیسرے ٹرمینل میں پیغامات نظر آنے لگیں گے!
...
```
آپ کو کچھوے کی بدلتی ہوئی x، y، اور theta (زاویہ) کی قدروں کو ظاہر کرنے والے پیغامات کا ایک مسلسل سلسلہ نظر آئے گا۔
...
جب آپ اسے چلاتے ہیں، تو آپ دیکھیں گے کہ کچھوا ایک دائرے میں حرکت کرنا شروع کر دیتا ہے، چاہے turtle_teleop_key نوڈ نہ چل رہا ہو! اب آپ روبوٹ کو براہ راست کمانڈ لائن سے کنٹرول کر رہے ہیں۔ پبلش کرنا بند کرنے کے لیے اس ٹرمینل میں Ctrl+C دبائیں۔
